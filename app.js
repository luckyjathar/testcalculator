...
function calculateFastData() {
    ...
    if (fixedEmi > 0) { 
        ...
        // 🔥 RULE: Base EMI 900 च्या खाली नसावा 
        ...
        if (cap > 0 && emi > cap) { 
            ...
            if (inv > 0 && loan > inv) loan = inv; // Re-check
...
function toggleZatpatCalc() {
    // युझर कोणत्याही पेजवर असला तरी आधी होम पेजवर नेईल आणि झटपट कॅल्क्युलेटर जवळ स्क्रोल करेल
    goHome();
    setTimeout(() => {
        window.scrollTo({ top: 0, behavior: 'smooth' });
        // झटपट कॅल्क्युलेटर बॉक्सला एक हलका 'ग्लो' (Glow) इफेक्ट द्या
